    ...
    return (
        <ContainerBlock title="How to change color theme to dark?">
            ...
            <div className='container'>
                ...
                <button className='button px-6 py-2 rounded-md block mx-auto my-auto mb-6'><a href='how-to-go-from-a-specific-direction-of-your-choice-to-your-destination'>Next Page</a></button>
            </div>
        </ContainerBlock>
    )
}
