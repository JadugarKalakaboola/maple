        ...
        <ContainerBlock>
            <div className="pb-10 flex flex-wrap-reverse justify-between lg:px-16">
                ...
                <div className="font-Teko text-6xl lg:w-5/12 flex flex-col justify-center">
                    ...
                    <a href="https://map-zeroday.vercel.app/" target={'_blank'} className="w-fit mx-auto button py-3 px-10 rounded-md text-3xl hover:brightness-75 mb-5"><button>Go Now</button></a>
                </div>
            </div>
        </ContainerBlock>
    )
